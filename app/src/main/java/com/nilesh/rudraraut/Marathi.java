...
public class Marathi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map=findViewById(R.id.imageButton);
                ...
                JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET,
                                    ...
                                    JsonObjectRequest request1=new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                                        ...
                                        public void onResponse(JSONObject response) {
                                            try {
                                                ...
                                                Toast.makeText(Marathi.this, "Sucess", Toast.LENGTH_SHORT).show();
                                            ...
                                            error -> Toast.makeText(Marathi.this,error.toString(), Toast.LENGTH_SHORT
                                            ).show());
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toast.makeText(Marathi.this, error.toString(), Toast.LENGTH_SHORT).show();
                            }
                        });
                queue.add(request);
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Marathi.this, Maps.class);
